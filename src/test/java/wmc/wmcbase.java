...
public class wmcbase {
	...
	@Test(priority = 2)
	public void deletepromo() throws InterruptedException, IOException, TesseractException, AWTException {
	...
	@Test(priority = 1)
	public void createpromo() throws InterruptedException, IOException, TesseractException, AWTException {
		driver.get("http://10.0.6.125:8000/");
		driver.manage().window().setSize(new Dimension(1050, 652));
		driver.findElement(By.name("Username")).click();
		Thread.sleep(1000);
		...
		String firstAlertText = driver.switchTo().alert().getText();
		if (!firstAlertText.equals("Do you want to create this promotion?")) {
			throw new AssertionError("Unexpected alert text: " + firstAlertText);
		}
		...
		String firstAlertText1 = driver.switchTo().alert().getText();
		if (!firstAlertText1.equals("Promotion created successfully")) {
			throw new AssertionError("Unexpected alert text: " + firstAlertText1);
		}
