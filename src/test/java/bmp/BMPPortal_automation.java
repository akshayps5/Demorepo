...
public class BMPPortal_automation {
	...
	public void setUp() {
		...
		BMPPortal_automation.driver = driver; // Set the WebDriver instance
	...
	@Test(priority = 2)
	public void SMS_configuation_listmgmt_cannedmsg() throws InterruptedException {
		driver.findElement(By.xpath("//a[normalize-space()='Site Map']")).click();
		Thread.sleep(2000);
	...
	@Test(priority = 3)
	public void SMS_canned_binary_text_unicode() throws InterruptedException {
		driver.findElement(By.xpath("//a[normalize-space()='Site Map']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//a[normalize-space()='Portal GUI']")).click(); // portal gui
		Thread.sleep(2000);
	...
	@Test(priority = 4)
	public void SMS_contAdmin_myAcc_Status() throws InterruptedException {
		driver.findElement(By.xpath("//a[normalize-space()='Site Map']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//a[normalize-space()='Portal GUI']")).click(); // portal gui
		Thread.sleep(2000);
				...
				for (String handle1 : windowHandles1) {
					...
					if (!handle1.equals(mainWindowHandle)) {
						...
						if (driver.getCurrentUrl()
								.equals("https://10.0.0.21:8443/bmpportal/pages/status_current.jsp")) {
