package snd;
	...
	public class prepaidrechargerc9 {
		...
		public void generateRefIdAndOrderNo() throws Exception {
	        ...
	        Response = resp.getString("detail");
	        ...
	        System.out.println("API Returned Response = " + Response );
	 
			
		}

		@Test(priority = 2, enabled = true , dependsOnMethods = "generateRefIdAndOrderNo" )
		...
		@Test(priority = 3, enabled = true ,dependsOnMethods = "generateRefIdAndOrderNo")
		...
		@Test(priority = 5, enabled = true , dependsOnMethods="generateRefIdAndOrderNo")
