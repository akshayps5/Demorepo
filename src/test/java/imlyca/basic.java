package imlyca;
	...
	public class basic {
		...
		public void freeMsisdn1() throws InterruptedException{
			...
			WebElement pkgField = wait.until(ExpectedConditions.elementToBeClickable(By.id("msisdnCnt")));
			pkgField.click();
			pkgField.clear();
			pkgField.sendKeys("1");
			pkgField.sendKeys(Keys.TAB); // Optional
		...
		public void bundling() throws InterruptedException{
		 ...
		 if (userInput1 != null && !userInput1.trim().isEmpty()) {
			...
			js.executeScript("window.scrollBy(500,0)"); // Scrolls up by 500 pixels
		}
