package csmp;
	...
	public class packcreate extends DataProvider4CSMP {
	...
	@Test (dataProvider = "getDetails", priority = 1, enabled = true)
	public void PackCreation(String pkg_name, String keywd, String description , String RenewCount , String validity, String purchaseUnit, String minBal, String PackPurchaseDebitComment,
		...
		driver.findElement(By.xpath("//a[normalize-space()='Create Pack']")).click();  // Click on Create Pack
		Thread.sleep(3000);
